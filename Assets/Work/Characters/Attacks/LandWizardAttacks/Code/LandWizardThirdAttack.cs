...
namespace Work.Characters.Attacks.LandWizardAttacks.Code
{
    public class LandWizardThirdAttack : AbstractCharacterAttack
    {
        ...
        public override void Attack()
        {
            ...
            _params.GetValue("EffectObject", out effectPrefab);
            Debug.Assert(effectPrefab != null , "Effect Object not find");
            ...
            GameObject effect = MonoBehaviour.Instantiate(effectPrefab, _sensor.CurrentTarget.Transform.position,Quaternion.identity);
